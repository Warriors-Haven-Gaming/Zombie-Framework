...
Parameters:
	Array | String types:
		One or more horde types to return. Can be any of:
			...
			"mixedZombies" (represents all fast, medium, slow, and walker types)
...
private _resolvedTypes = _this apply {
	switch (_x) do {
		...
		case "mixedZombies": {flatten (call SHZ_fnc_hordeTypeList - ["demons", "spiders", "crawlers"] apply {_x call SHZ_fnc_hordeType})};
		default {[]};
	};
};
